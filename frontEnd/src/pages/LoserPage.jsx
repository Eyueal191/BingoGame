  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-xl mt-12 md:mt-16 animate-float">
        ...
        {/* Loser Message Box */}
        <div className="bg-gradient-to-t from-white/10 to-white/20 border border-red-400/50 px-12 py-6 rounded-xl shadow-2xl backdrop-blur-lg mb-12 flex flex-col items-center gap-3">
          <Trophy className="w-12 h-12 text-red-400" />
          <p className="text-4xl md:text-5xl font-extrabold drop-shadow-lg tracking-wider text-red-300 text-center">
        ...
        <ul className="mt-10 space-y-4 text-lg text-white/90">
          ...
          <li className="flex items-center gap-3 font-medium">
            <Star className="w-6 h-6 text-red-400 flex-shrink-0" />
